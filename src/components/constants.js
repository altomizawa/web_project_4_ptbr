...
const thisUserInfo = await clientApi.getUser()
...
export {apiUrl, authorization, clientApi, cardsParent, cardTemplate, forms, profileName, profileProfession, profilePicture, profilePictureEditButton, profilePopup, cardImagePopup, deleteCardConfirmationPopup, thisUserInfo}